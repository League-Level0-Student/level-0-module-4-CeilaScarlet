...
public class FruitQuiz extends KeyAdapter {
	...
	question2 = new JLabel("<html>Who's more fabulous? <br> A: Matt <br> B: Dave <br> C: Jackie</html>");
	question3 = new JLabel("<html>Who's cooler? <br> A: Matt <br> B: Dave <br> C: Jackie</html>");}
	@Override
